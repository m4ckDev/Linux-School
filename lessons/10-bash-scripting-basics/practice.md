...
Practice the commands from Module 10: **Bash Scripting Basics**.
...
```bash
mkdir -p ~/linux-school-practice/module-10
cd ~/linux-school-practice/module-10
```
...
```bash
bash chmod echo read variables if loops
```
...
```bash
rm -rf ~/linux-school-practice/module-10
```
