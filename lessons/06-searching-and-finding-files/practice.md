# Practice — Searching and Finding Files

## Goal

Practice the commands from Module 06: **Searching and Finding Files**.
...
```bash
mkdir -p ~/linux-school-practice/module-06
cd ~/linux-school-practice/module-06
```
...
```bash
rm -rf ~/linux-school-practice/module-06
```
