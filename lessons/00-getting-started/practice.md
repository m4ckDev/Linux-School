...
Practice the commands from Module 00: **Getting Started**.
...
```bash
mkdir -p ~/linux-school-practice/module-00
cd ~/linux-school-practice/module-00
```
...
```bash
rm -rf ~/linux-school-practice/module-00
```
