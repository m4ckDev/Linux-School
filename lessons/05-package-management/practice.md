...
Practice the commands from Module 05: **Package Management**.
...
```bash
mkdir -p ~/linux-school-practice/module-05
cd ~/linux-school-practice/module-05
```
...
```bash
rm -rf ~/linux-school-practice/module-05
```
