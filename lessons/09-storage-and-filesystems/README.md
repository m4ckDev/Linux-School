# Module 09 — Storage and Filesystems

## Overview

This module introduces **Storage and Filesystems** as part of the Linux School learning path.
...
| [Lab](../../labs/lab-10-storage-and-filesystems.md) | Full lab assignment |
| [Challenge](../../challenges/beginner/challenge-09-storage-and-filesystems.md) | Beginner challenge |
| [Quiz](../../quizzes/quiz-10-storage-and-filesystems.md) | Knowledge check |
...
```bash
df du lsblk mount umount blkid
```
