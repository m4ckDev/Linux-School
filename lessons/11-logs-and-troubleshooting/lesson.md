# Lesson — Logs and Troubleshooting

## Purpose

This lesson teaches the basics of **Logs and Troubleshooting** in Linux.
...
```bash
journalctl dmesg tail grep systemctl
```
...
Linux users need to understand Logs and Troubleshooting because it affects daily terminal work, troubleshooting, system administration, and cybersecurity tasks.
...
```bash
mkdir -p ~/linux-school-practice/module-11
cd ~/linux-school-practice/module-11
```
