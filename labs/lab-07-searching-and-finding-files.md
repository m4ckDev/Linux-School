# Lab 07 — Searching and Finding Files

## Objective

Complete a hands-on Linux lab focused on **Searching and Finding Files**.
...
```bash
mkdir -p ~/linux-school-labs/lab-07
cd ~/linux-school-labs/lab-07
```
...
```bash
rm -rf ~/linux-school-labs/lab-07
```
