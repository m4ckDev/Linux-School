...
You are working in a Linux environment and need to solve a beginner-level issue related to **Getting Started**.

---

## Mission

Use the skills from Module 00 to inspect the system, identify the issue, and apply the correct fix.
