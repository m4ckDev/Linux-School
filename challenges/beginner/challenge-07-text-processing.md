# Challenge 07 — Text Processing

## Scenario

You are working in a Linux environment and need to solve a beginner-level issue related to **Text Processing**.

---

## Mission

Use the skills from Module 07 to inspect the system, identify the issue, and apply the correct fix.
