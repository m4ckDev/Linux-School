# Challenge 06 — Searching and Finding Files

## Scenario

You are working in a Linux environment and need to solve a beginner-level issue related to **Searching and Finding Files**.

---

## Mission

Use the skills from Module 06 to inspect the system, identify the issue, and apply the correct fix.
