# Challenge 08 — Networking Basics

## Scenario

You are working in a Linux environment and need to solve a beginner-level issue related to **Networking Basics**.

---

## Mission

Use the skills from Module 08 to inspect the system, identify the issue, and apply the correct fix.
