...
You are working in a Linux environment and need to solve a beginner-level issue related to **Navigation**.

---

## Mission

Use the skills from Module 01 to inspect the system, identify the issue, and apply the correct fix.
