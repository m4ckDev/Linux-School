# Challenge 03 — Users and Permissions

## Scenario

You are working in a Linux environment and need to solve a beginner-level issue related to **Users and Permissions**.

---

## Mission

Use the skills from Module 03 to inspect the system, identify the issue, and apply the correct fix.
...
```bash
whoami id groups chmod chown stat
```
