# Challenge 12 — Security Fundamentals

## Scenario

You are working in a Linux environment and need to solve a beginner-level issue related to **Security Fundamentals**.

---

## Mission

Use the skills from Module 12 to inspect the system, identify the issue, and apply the correct fix.
