# Challenge 09 — Storage and Filesystems

## Scenario

You are working in a Linux environment and need to solve a beginner-level issue related to **Storage and Filesystems**.

---

## Mission

Use the skills from Module 09 to inspect the system, identify the issue, and apply the correct fix.
