# Challenge 02 — Files and Directories

## Scenario

You are working in a Linux environment and need to solve a beginner-level issue related to **Files and Directories**.

---

## Mission

Use the skills from Module 02 to inspect the system, identify the issue, and apply the correct fix.
